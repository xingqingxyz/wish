_pastel() {
    ...
    case "${cmd}" in
        pastel)
            ...
            case "${prev}" in
                ...
                -m)
                    ...
                    ;;
                --color-picker)
                    COMPREPLY=($(compgen -W "gpick xcolor wcolor grabc colorpicker chameleon kcolorchooser zenity yad hyprpicker gdbus" -- "${cur}"))
                    return 0
                    ;;
                *)
                    COMPREPLY=()
        ...
        pastel__distinct)
            ...
            ;;
        pastel__format)
            opts="-h --help rgb rgb-float hex hsl hsl-hue hsl-saturation hsl-lightness hsv hsv-hue hsv-saturation hsv-value lch lch-lightness lch-chroma lch-hue lab lab-a lab-b oklab oklab-l oklab-a oklab-b luminance brightness ansi-8bit ansi-24bit ansi-8bit-escapecode ansi-24bit-escapecode cmyk name <color>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        pastel__gradient)
            ...
            case "${prev}" in
                ...
                -n)
                    ...
                    ;;
                --colorspace)
                    COMPREPLY=($(compgen -W "Lab LCh RGB HSL OkLab" -- "${cur}"))
                    return 0
                    ;;
                -s)
                    COMPREPLY=($(compgen -W "Lab LCh RGB HSL OkLab" -- "${cur}"))
        ...
        pastel__saturate)
            ...
            ;;
        pastel__set)
            opts="-h --help lightness hue chroma lab-a lab-b oklab-l oklab-a oklab-b red green blue hsl-hue hsl-saturation hsl-lightness alpha <value> <color>..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
