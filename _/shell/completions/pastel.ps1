...
Register-ArgumentCompleter -Native -CommandName 'pastel' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'pastel;random' {
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Randomization strategy:    vivid:    random hue, limited saturation and lightness values    rgb:      samples uniformly in RGB space    gray:     random gray tone (uniform)    lch_hue:  random hue, fixed lightness and chroma  Default strategy: ''vivid''  ')
            [CompletionResult]::new('--strategy', '--strategy', [CompletionResultType]::ParameterName, 'Randomization strategy:    vivid:    random hue, limited saturation and lightness values    rgb:      samples uniformly in RGB space    gray:     random gray tone (uniform)    lch_hue:  random hue, fixed lightness and chroma  Default strategy: ''vivid''  ')
        ...
        'pastel;help;gradient' {
            break
        }
        'pastel;help;mix' {
            break
        }
        'pastel;help;colorblind' {
            break
        }
        'pastel;help;set' {
            break
        }
        'pastel;help;saturate' {
            break
        }
        'pastel;help;desaturate' {
            break
        }
        'pastel;help;lighten' {
            break
        ...
        'pastel;help;textcolor' {
            break
        }
        'pastel;help;colorcheck' {
            break
        }
        'pastel;help;help' {
            break
